    ...
    def generate_xlsx_report(self, workbook, data, partners):
        ...
        for invoice in docs:
            ...
            for note in debit_credit_notes:
                book_lines.append({ 'name':note.name, 'period':note.invoice_date, 'rif': note.partner_id.vat, 'customer': note.partner_id.display_name, 'prov_type': invoice.partner_id.partner_type_custom, 'control_number': 0, 'related_invoice': invoice.name, 'related_debit_note': 0, 'related_credit_note': 0, 'total_amount_with_taxes': note.amount_total, 'untaxed_amount': note.amount_untaxed_signed, 'tax_amount': note.amount_tax, 'tax_amount_held': 0.0, 'advance_payment': 0,})
            if (taxes_vouchers):
                for voucher in taxes_vouchers:
                    book_lines.append({ 'name':invoice.name, 'period':invoice.invoice_date, 'rif': voucher.related_invoice.partner_id.vat, 'customer': voucher.related_invoice.partner_id.display_name, 'prov_type': invoice.partner_id.partner_type_custom, 'control_number': 0, 'related_invoice': '', 'related_debit_note': 0, 'related_credit_note': 0, 'total_amount_with_taxes': voucher.total_amount, 'untaxed_amount': voucher.untaxed_amount, 'tax_amount': voucher.taxed_amount, 'tax_amount_held': voucher.taxed_amount_held, 'advance_payment': 0,})
            else:
                book_lines.append({ 'name':invoice.name, 'period':invoice.invoice_date, 'rif': invoice.partner_id.vat, 'customer': invoice.partner_id.display_name, 'prov_type': invoice.partner_id.partner_type_custom, 'control_number': invoice.control_number, 'related_invoice': '', 'related_debit_note': 0, 'related_credit_note': 0, 'total_amount_with_taxes': invoice.amount_total, 'untaxed_amount': invoice.amount_untaxed_signed, 'tax_amount': invoice.amount_tax, 'tax_amount_held': 0.0, 'advance_payment': 0,})      
